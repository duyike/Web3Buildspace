...
class TweetScoutAPI:
    ...
    async def fetch_user_tweets(self, handle: str, count: int = 40) -> list[dict]:
...
class TwitterAgent:
    def __init__(
        ...
        self.openai_client = openai.AsyncOpenAI(api_key=openai_key, base_url=openai_base_url)
    ...
    async def generate_agent(self, handle: str) -> bool:
        ...
        try:
            ...
            tweets = await self.tweetscout.fetch_user_tweets(handle)
